        ...
        <div>
          <h1 className="text-4xl font-bold text-white">
            <span className="text-5xl">
              cler<span className="text-orange-400">K</span>{" "}
            </span>{" "}
            brings all your tasks together
          </h1>
          <h3 className="font-normal text-white mt-2">
            Keep everything in the same place. Track and monitor progress..
          </h3>
          <PrimaryButton className="btn bg-gradient-to-l from-orange-300 to-orange-500 py-2 px-6 rounded-md text-white mt-4 text-xl font-semibold">
